...
public class Table {
	...
	/**
	 * Tries to create a table from the String input. If it fails, it will throw an IllegalArgumentException.
	 * 
	 * @param input
	 * @return
	 * @throws IllegalArgumentException
	 */
	public static Table fromString(String input) throws IllegalArgumentException {
